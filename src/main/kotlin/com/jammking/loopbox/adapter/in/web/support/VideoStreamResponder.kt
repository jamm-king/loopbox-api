...
@Component
class VideoStreamResponder {

    private val log = LoggerFactory.getLogger(javaClass)

    fun respond(
        target: GetVideoFileUseCase.VideoStreamTarget,
        headers: HttpHeaders
    ...
    private fun okFull(
        ...
        val body = StreamingResponseBody { os ->
            try {
                ...
                log.debug("Client aborted full video stream. path={}, reason={}", path, e.message)
            }
        }
    ...
    private fun partial(
        ...
        val body = StreamingResponseBody { os ->
            try {
                ...
                log.debug(
                    "Client aborted partial video stream. path={}, start={}, end={}, reason={}",
